...
namespace WebApplicationProject1.Controllers
{
    public class InvoicesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Invoice_No,Customer_ID,Invoice_Date,Invoice_Total")] Invoice invoice)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Invoice_No,Customer_ID,Invoice_Date,Invoice_Total")] Invoice invoice)
        {
            if (ModelState.IsValid)
            {
